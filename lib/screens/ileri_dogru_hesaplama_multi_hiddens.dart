...
class IleriDogruHesaplamaMultiHiddens extends StatefulWidget {
  @override
  _IleriDogruHesaplamaMultiHiddensState createState() =>
      _IleriDogruHesaplamaMultiHiddensState();
}

class _IleriDogruHesaplamaMultiHiddensState
    extends State<IleriDogruHesaplamaMultiHiddens> {
                      ...
                      Flexible(
                        ...
                        child: XYInputField(
                          ...
                          hintText: countInputsHiddens <
                              ...
                              : (countHiddens2Outputs <
                                      (hiddens.length * outputs.length)
                                  ? hintTextsHiddens2Outputs[0]
                                      [countHiddens2Outputs]
                                  : 'Done'),
                        ),
                      ),
                          ...
                          onTap: () {
                            ...
                            if (countInputsHiddens ==
                              ...
                              _controller1.text = hiddensCikisList[
                                      countHiddens2Outputs % hiddens.length]
                                  .toStringAsFixed(2);
